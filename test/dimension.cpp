...
// 			.convert(list, hana::tuple_c< std::size_t, 0, 0 >);
...

	{
		...
		constexpr auto index_201_00 = dimension_solver< dims, morph, 0, 1 >::solve(
			type_index::type_id< morph< double, int > >(), hana::make_tuple());
		...
		constexpr auto index_201_11 = dimension_solver< dims, morph, 0, 1 >::solve(
			type_index::type_id< morph< char, bool > >(), hana::make_tuple());
		...
		constexpr auto index_202_13 = dimension_solver< dims, morph, 0, 2 >::solve(
			type_index::type_id< morph< char, long long > >(), hana::make_tuple());
		...
		constexpr auto index_210_12 = dimension_solver< dims, morph, 1, 0 >::solve(
			type_index::type_id< morph< bool, float > >(), hana::make_tuple());
		...
		constexpr auto index_3120_103 = dimension_solver< dims, morph, 1, 2, 0 >::solve(
			type_index::type_id< morph< int, long long, char > >(), hana::make_tuple());
		...
		constexpr auto index_312100_10133 = dimension_solver< dims, morph, 1, 2, 1, 0, 0 >
			::solve(
			type_index::type_id< morph< int, long long, int, char, char > >(),
			hana::make_tuple());
