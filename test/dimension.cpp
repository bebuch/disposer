...
// 			.convert(list, hana::tuple_c< std::size_t, 0, 0 >);
...

	{
		...
		auto index_10_0 = dimension_solver< dims, morph, 0 >::solve(
		...
		auto index_10_1 = dimension_solver< dims, morph, 0 >::solve(
		...
		auto index_10_2 = dimension_solver< dims, morph, 0 >::solve(
		...
		auto index_11_0 = dimension_solver< dims, morph, 1 >::solve(
		...
		auto index_11_1 = dimension_solver< dims, morph, 1 >::solve(
		...
		auto index_12_0 = dimension_solver< dims, morph, 2 >::solve(
		...
		auto index_12_1 = dimension_solver< dims, morph, 2 >::solve(
		...
		auto index_12_2 = dimension_solver< dims, morph, 2 >::solve(
		...
		auto index_12_3 = dimension_solver< dims, morph, 2 >::solve(
		...
		auto index_201_00 = dimension_solver< dims, morph, 0, 1 >::solve(
		...
		auto index_201_11 = dimension_solver< dims, morph, 0, 1 >::solve(
		...
		auto index_202_13 = dimension_solver< dims, morph, 0, 2 >::solve(
		...
		auto index_210_12 = dimension_solver< dims, morph, 1, 0 >::solve(
			hana::type_c< morph< bool, float > >, hana::make_tuple());
		...
		auto index_3120_103 = dimension_solver< dims, morph, 1, 2, 0 >::solve(
		...
		auto index_312100_10133 = dimension_solver< dims, morph, 1, 2, 1, 0, 0 >
			::solve(
